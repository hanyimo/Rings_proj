	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div class="row" style="margin:0px;width:100%;">
			<div class="col-xs-12" style="margin-left:200px; margin-top:-250px;width:85%;">
				<h3 class="header smaller lighter blue" style="width:100%;">帖子详情<a href="${pageContext.request.contextPath}/design/invitation_manager" style="float:right;margin:0px 92px 0px 0px;text-decoration: none;">返回</a></h3>
				<div style="margin-left:292px;width:66%;">
					<div class="pull-right tableTools-container"></div>
				</div>
				<!-- 弹框 -->
				<div class="col-xs-12 col-sm-6 widget-container-col" id="widget-container-col-4" style="width:73.5%;position:fixed;top:21%;left:20%;">
					<div class="widget-box" id="widget-box-4">
						<div class="widget-header widget-header-large" style="text-align: center;">
							<h4 class="widget-title" >${invitation.invTitle }</h4>
						</div>
						<div class="widget-body" style="height:400px;">
							<div class="widget-main" id="fontmassage">
