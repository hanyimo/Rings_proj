...
<body>
   ...
   <%@ include file="client/header.jsp" %>
    ...
    <div class="main-menu">
        ...
        <div class="right-box small-box " id="right-box" style="padding:0px;position:absolute;left:280px;top:-20px;">
       		<div id="one" style="margin-left:200px;magin-top:0px;position:absolute;left:120px;top:-50px;">
				<table class="table" cellspacing="0" style="font-size: 12px;">
				    	<p>用户名:<input type="text" name="userName" value="${user.userName}" readonly="readonly"/></p><br>
				    	<p>昵称:<input type="text" name="userAlice" value="${user.userAlice}" readonly="readonly"/> </p><br>
				    	<p>性别:<input type="text" name="userSex" value="${user.userSex}" readonly="readonly"/> </p><br>
				    	<p>邮箱:<input type="text" name="userEmail" value="${user.userEmail}" readonly="readonly"/> </p><br>
				</table>
			</div>
        </div>
    	</div>
