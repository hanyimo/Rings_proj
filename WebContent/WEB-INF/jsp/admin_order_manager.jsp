	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div class="row" style="margin:0px 0px 60px 0px;width:100%;">
			<div class="col-xs-12" style="margin-left:200px; margin-top:-250px;width:85%;">
				<h3 class="header smaller lighter blue" style="width:100%;">订单列表</h3>
				<div style="margin-left:292px;width:66%;">
					<div class="pull-right tableTools-container"></div>
				</div>
				<div class="table-header" style="width:86%;margin-left:70px;">订单显示列表</div>
					...
					<table id="dynamic-table"
						...
						<tbody>
							...
							<tr>
								...
								<td class="center"><fmt:formatDate value="${order.order_time}" pattern="yyyy-MM-dd" /></td>
								<c:choose>
            					<c:when test="${order.shipment_status=='已发货'}">
            						<td class="center">
            							<a href="#">
								  			<span class="label label-sm label-success">已发货</span>
										</a>
									</td>
            					</c:when>
            					<c:otherwise>
            						<td class="center">
            							<a href="#">
								  		<span class="label label-sm label-inverse">未发货</span>
										</a>
									</td>
            					</c:otherwise>
            					</c:choose>
								<td class="center">
									<div class="hidden-sm hidden-xs btn-group">
										<!-- 发货 -->
										<a href="${pageContext.request.contextPath }/client/success_shipment_status/${order.oid}" title="通过">
											<i class="ace-icon fa fa-check green bigger-130"></i>
										</a>&nbsp;
										<!-- 未发货 -->
										<a href="${pageContext.request.contextPath }/client/no_shipment_status/${order.oid}" title="不通过">
