                  ...
                  <ul class="nav navbar-nav">
                     ...
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                           <li><a href="${pageContext.request.contextPath }/product">分类1</a></li>
                           <li><a href="product.jsp">分类2</a></li>
                           <li><a href="product.jsp">分类3</a></li>
                        </ul>
                     </li>
                     <!-- 登录后可看到个人设置，登录位置变成个人设置 -->
                      ...
                      <li><a href="${pageContext.request.contextPath }/design">设计空间</a></li>
