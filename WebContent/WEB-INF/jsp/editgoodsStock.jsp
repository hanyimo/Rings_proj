...
<body class="no-skin">
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<h4 class="header green" style="margin-left: 220px;">修改商品库存</h4>
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form method="post" action="${pageContext.request.contextPath}/server/EditgoodsStock">
								<fieldset>
								<input type="hidden" name="gid" value="${goods.gid}"/>
									<label for="goodsStock">商品库存：</label> 
									<input type="text" name="goodsStock" required="required" value="${goods.goodsStock}" />
								</fieldset>
