...
<body class="no-skin">
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<!-- 右侧版块 -->
		<div class="row" style="margin:0px 0px 60px 0px;width:100%;">
			<div class="col-xs-12" style="margin-left:200px; margin-top:-250px;width:85%;">
				<h3 class="header smaller lighter blue" style="width:100%;">帖子列表</h3>
				<div style="margin-left:292px;width:66%;">
					<div class="pull-right tableTools-container"></div>
				</div>
				<div class="table-header" style="width:86%;margin-left:70px;">帖子显示列表</div>

				<!-- div.dataTables_borderWrap -->
				<div style="width:86%;margin-left:70px;">
					<table id="dynamic-table"
						...
						<tbody>
							...
							<tr>
								<td class="center">${in.uid.userName }</td>
								<td class="center">${in.uid.userAlice }</td>
								<!-- 点击标题可进行查看 -->
								<td class="center"><a href="${pageContext.request.contextPath }/design/invitation_view_manager/${in.invid}">${in.invTitle }</a></td>
								<td class="center"><fmt:formatDate value="${in.invCreatDate }" pattern="yyyy-MM-dd" /></td>
								<td class="center">
									<span>
										<fmt:formatDate value="${in.invAuditDate}" pattern="yyyy-MM-dd " />
									</span>
								</td>
								<c:choose>
            					...
            					<c:when test="${in.status==2}">
            						<td class="center">
            							<a href="#">
								  		<span class="label label-sm label-inverse">未通过</span>
										</a>
									</td>
            					</c:when>
            					<c:otherwise>
								...
								<td class="center">
									<div class="hidden-sm hidden-xs btn-group">
										<!-- 审核通过 -->
										<a href="${pageContext.request.contextPath }/design/success/${in.invid}" title="通过">
											<i class="ace-icon fa fa-check green bigger-130"></i>
										</a>&nbsp;
										<!-- 审核不通过 -->
										<a href="${pageContext.request.contextPath }/design/no/${in.invid}" title="不通过">
