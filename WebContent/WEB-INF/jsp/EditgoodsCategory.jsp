...
<body class="no-skin">
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<h4 class="header green" style="margin-left: 220px;">编辑商品分类</h4>
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form:form cssClass="form" method="post" modelAttribute="category"
								action="${pageContext.request.contextPath }/server/EditgoodsCate">
								<form:hidden path="categoryId"/>
								<fieldset>
									<form:label path="category">分类名称：</form:label>
...
$(function(){	
				$("#back").click(function(){
					...
					location.href="${pageContext.request.contextPath}/server/goodsManage";
				});
			});
</script>
</body>
